  ...
  intuition:{
    ...
    visualizations:[{id:'PythonNotebook',title:'Distributions and the Normal',props:{initialCells:[
      ...
      {id:4,cellTitle:'Stage 4 — Central Limit Theorem Demo',
       ...
       instructions:'Predict before running: will the skewness of the individual draws change as N grows? Run and compare the two skew columns. Notice that at N=30 the means are still visibly skewed (about 0.37) — the N≥30 rule of thumb is not a guarantee. Then change N_plot to 100 and compare the blue histogram.',
