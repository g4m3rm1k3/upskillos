    ...
    visualizations: [
      {
        ...
        props: {
          initialCells: [
            ...
            {
              id: 2,
              cellTitle: 'The Iterator Protocol — applied in a real function',
              prose: [
                '## How the Code Works',
            ...
            {
              id: 4,
              cellTitle: 'Making a custom iterator class — applied in a real function',
              prose: [
                '## How the Code Works',
            ...
            {
              id: 6,
              cellTitle: 'Generator functions — yield — applied in a real function',
              prose: [
                '## How the Code Works',
              ...
              typeIt: true,
              solution: 'def count_up(start, stop):\n    current = start\n    while current < stop:\n        yield current\n        current += 1',
              code: '',
              output: '', status: 'idle', figureJson: null,
            },
            {
            ...
            {
              id: 8,
              cellTitle: 'Infinite generators — applied in a real function',
              prose: [
                '## How the Code Works',
            ...
            {
              id: 10,
              cellTitle: 'Generator expressions — applied in a real function',
              prose: [
                '## How the Code Works',
              ...
              typeIt: true,
              solution: 'gen = (x**2 for x in range(10) if x % 2 == 0)\nprint(next(gen))\nprint(next(gen))\nprint(list(gen))',
              code: '',
              output: '', status: 'idle', figureJson: null,
            },
            {
            ...
            {
              id: 12,
              cellTitle: 'itertools — applied in a real function',
              prose: [
                '## How the Code Works',
            ...
            {
              id: 14,
              cellTitle: 'Using yield from — applied in a real function',
              prose: [
                '## How the Code Works',
