...
- [ ] Low priority: give the 14 precalculus lessons unique ids (the rule in `AGENTS.md`). Progress moves exactly (`precalculus::<id>`) with the split mechanism used for `la8-001`.
